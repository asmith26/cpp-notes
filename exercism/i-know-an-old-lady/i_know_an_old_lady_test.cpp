...
BOOST_AUTO_TEST_CASE(fly)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(1));
}
...
BOOST_AUTO_TEST_CASE(spider)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(2));
}
...
BOOST_AUTO_TEST_CASE(bird)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(3));
}
...
BOOST_AUTO_TEST_CASE(cat)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(4));
}
...
BOOST_AUTO_TEST_CASE(dog)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(5));
}
...
BOOST_AUTO_TEST_CASE(goat)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(6));
}
...
BOOST_AUTO_TEST_CASE(cow)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(7));
}
...
BOOST_AUTO_TEST_CASE(horse)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verse(8));
}
...
BOOST_AUTO_TEST_CASE(multiple_verses)
{
    ...
    BOOST_REQUIRE_EQUAL(expected, i_know_an_old_lady::verses(1, 2));
}

BOOST_AUTO_TEST_CASE(the_whole_song)
{
    BOOST_REQUIRE_EQUAL(i_know_an_old_lady::verses(1, 8), i_know_an_old_lady::sing());
}
#endif
